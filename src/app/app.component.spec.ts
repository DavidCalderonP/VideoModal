...
describe('AppComponent', () => {
  ...
  it('ejemplo prueba', ()=>{
    ...
    const valor = appComponent.value;
    expect(valor).toEqual('VaLuE');
  });

  it('Peticion en el app component', ()=>{
    const fixture = TestBed.createComponent(AppComponent);
    const app = fixture.componentInstance;
   ...
   const users = spyOn(servicio, 'obtenerUsuarios').and.callFake(()=>{
